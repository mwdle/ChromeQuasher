...
## Read this first:
As of Selenide version 6.17.0 (as far as I know) this issue that led to the creation of ChromeQuasher has been fixed with Selenide's automatic management of WebDrivers. Therefore, this tool does not serve much purpose in practical applications and stands here only as a reference.
